...
import { KANBAN_BOARDS } from '@/lib/constants'
...
export default function FunilPage() {
  ...
  async function handleDragEnd(result: DropResult) {
    ...
    const columns = [...KANBAN_BOARDS[BOARD].columns] as string[]
    ...
    <>
      ...
      <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        <KanbanBoard
          ...
          onAddCard={columnName => openModal({ column_name: columnName, board: BOARD })}
        />
      </div>
